          ...
          children: [
            ...
            _LiveStockSection(
              ...
              child: Column(
                children: [
                  _BranchStockCard(
                    title: ApiEndpoints.ahmLabel,
                    branches: ahmBranches,
                    accentColor: const Color(0xFFD97706),
                  ),
                  const SizedBox(height: 12),
                  _BranchStockCard(
                    title: ApiEndpoints.bhuLabel,
                    branches: bhuBranches,
                    accentColor: const Color(0xFF4C1D95),
                  ),
                ],
              ),
            ...
            _LiveStockSection(
              title: 'All Prices',
              child: detail.prices.isEmpty
                  ? const _EmptyCopy(
                      message: 'No price rows found for this item.',
                    )
                  : Column(
                      children: detail.prices
                          .map(
                            (price) => Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          if (branches.isEmpty)
            const _EmptyCopy(
              message:
                  'No branch-wise stock details were returned by this server.',
            )
          else
            ...branches.map(
              (branch) => Padding(
          ...
          Row(
            children: [
              Expanded(
                child: _MiniMetric(
                  label: 'Base',
                  value: _formatNumber(price.basePrice),
                ),
              ),
              ...
              Expanded(
                child: _MiniMetric(
                  label: 'Discount',
                  value: '${_formatNumber(price.discountPercent)}%',
                ),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: _MiniMetric(
                  label: 'Final',
                  value: _formatNumber(price.finalPrice),
                  emphasized: true,
                ),
              ),
            ],
